...
public class IconData
{
    ...
    public IconData(Sprite sprite, string id)
    {
        IconSprite = sprite;
        IconId = id;
    }
...
public class Monster : ScriptableObject
{
    ...
    //Balance as needed. These values should probably align with lore, such as a knight having more physical armor.
    //Scale brawn & constitution before modding these values, this should be for fine tuning.
    ...
    //[TabGroup("Balance Data")] public Skill restSkill;
